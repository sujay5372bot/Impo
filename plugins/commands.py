        ...
        for file in files:
            ...
            if not await db.has_premium_access(message.from_user.id):
                if not await check_verification(client, message.from_user.id) and VERIFY == True:
                    ...
                    await message.reply_text(
                        text="<b>You are not verified !\nKindly verify to continue !\nᴘʟᴇᴀꜱᴇ ᴄʟɪᴄᴋ ᴏɴ ᴠᴇʀɪғʏ & ɢᴇᴛ ᴜɴʟɪᴍɪᴛᴇᴅ ᴀᴄᴄᴇꜱꜱ ғᴏʀ ᴛɪʟʟ ɴᴇxᴛ ᴠᴇʀɪғɪᴄᴀᴛɪᴏɴ !\nএকবার ভেরিফাই করুন আর পরবর্তী 24 ঘণ্টা আনলিমিটেড এড ফ্রী ফাইল পান । \nভেরিফাই করতে verify এ ক্লিক করুন ✓ কীভাবে ভেরিফাই করবেন না জানলে How to Verify এ ক্লিক করুন 😊
