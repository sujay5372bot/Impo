        ...
        for file in files:
            ...
            if not await db.has_premium_access(message.from_user.id):
                if not await check_verification(client, message.from_user.id) and VERIFY == True:
                    ...
                    await message.reply_text(
                        text="<b>You are not verified !\nKindly verify to continue !📌 ʏᴏᴜ ᴀʀᴇ ɴᴏᴛ ᴠᴇʀɪғɪᴇᴅ ᴛᴏᴅᴀʏ, ᴘʟᴇᴀꜱᴇ ᴄʟɪᴄᴋ ᴏɴ ᴠᴇʀɪғʏ & ɢᴇᴛ ᴜɴʟɪᴍɪᴛᴇᴅ ᴀᴄᴄᴇꜱꜱ ғᴏʀ ᴛɪʟʟ ɴᴇxᴛ ᴠᴇʀɪғɪᴄᴀᴛɪᴏɴ

!/n#ᴠᴇʀɪꜰɪᴄᴀᴛɪᴏɴ:- একবার ভেরিফাই করুন আর পরবর্তী 24 ঘণ্টা আনলিমিটেড এড ফ্রী ফাইল পান । ভেরিফাই করতে verify এ ক্লিক করুন ✓ কীভাবে ভেরিফাই করবেন না জানলে How to Verify এ ক্লিক করুন 😊

যদি ডাইরেক্ট ফাইল চান তাহলে Remove Ads এ ক্লিক করুন ।/n 𝐢ғ ʏᴏᴜ ᴡᴀɴᴛ ᴅɪʀᴇᴄᴛ Ғɪʟᴇꜱ ᴡɪᴛʜᴏᴜᴛ ᴀɴʏ ᴠᴇʀɪғɪᴄᴀᴛɪᴏɴꜱ ᴛʜᴇɴ 𝐂𝐥𝐢𝐜𝐤 𝐭𝐨 𝐑𝐞𝐦𝐨𝐯𝐞 𝐀𝐝𝐬 ⭐ 
